    ...
    return (
        <div className="border-b flex dark:bg-slate-800 justify-between px-10 py-4">
            ...
            <div className="flex items-center space-x-4">
                ...
                <Link to={`/publish`}>
                    <button type="button" className="px-6 mr-2 text-white bg-green-700 hover:bg-green-800 focus:outline-none focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5">
                        Write
                    </button>
                </Link>
